...
import { CreateOpDto, GetOpParamsDTO, IOp, UpdateOpDto } from './op.dto';
      ...
      for (const myOp of opWithFilters) {
        ...
        */
        ...
        ops.push({
          ...
          villageId: myOp.villageId == null ? 0 : myOp.villageId,
          villageName: myOp.villageName == null ? '' : myOp.villageName,
          localiteId: myOp.localiteId == null ? 0 : myOp.localiteId,
          localiteName: myOp.localiteName == null ? '' : myOp.localiteName,
          sousZoneId: myOp.sousZoneId == null ? 0 : myOp.sousZoneId,
          sousZoneName: myOp.sousZoneName == null ? '' : myOp.sousZoneName,
          zoneId: myOp.zoneId == null ? 0 : myOp.zoneId,
          zoneName: myOp.zoneName == null ? '' : myOp.zoneName,
