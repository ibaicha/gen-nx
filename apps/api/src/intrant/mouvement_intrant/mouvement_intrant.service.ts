    ...
    try {
      ...
      for (const myMouvement of mouvementIntrantWithFilters) {
        ...
        mouvementIntrants.push({
          ...
          fournisseurName:
            myMouvement.fournisseurName != null
          ...
          entrepotDestinationName: myMouvement.entrepotDestinationName,
          pointDestinationId: myMouvement.pointDestinationId,
          pointDestinationName: myMouvement.pointDestinationName,
        });
      }
