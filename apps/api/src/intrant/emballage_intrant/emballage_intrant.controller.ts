...
export class EmballageIntrantController {
  constructor(
    private readonly emballageIntrantService: EmballageIntrantService,
  ) {}
  ...
  get(
    ...
    createEmballageDto: CreateEmballageIntrantDto,
  ) {
  ...
  delete(
    @Param('id', ParseIntPipe) emballageId: number,
    createEmballageIntrantDto: CreateEmballageIntrantDto,
    @Req() request: Request,
  ) {
  ...
  update(
    ...
    return this.emballageIntrantService.update(
      emballageId,
      updateEmballageIntrantDto,
    )
  }
