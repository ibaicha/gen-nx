...
export class MouvementStockController {
  ...
  getAllMouvementStockProduitCampagne(
    ...
    return this.mouvementStockService.getAllMouvementStockProduitCampagne(
      produitId,
      anneeId,
      saisonId,
    )
  ...
  getAllMouvementStockOpProduitCampagne(
    ...
    return this.mouvementStockService.getAllMouvementStockOpProduitCampagne(
      opId,
      produitId,
      anneeId,
      saisonId,
  ...
  update(
    ...
    return this.mouvementStockService.update(
      mouvementStockId,
      updateMouvementStockDto,
    )
  }
