...
export class RemboursementController {
  ...
  getAllRemboursementsFromExploitation(
    @Param('id', ParseIntPipe) exploitationId: number,
  ) {
    return this.remboursementService.getAllRemboursementsFromExploitation(
      exploitationId,
    )
  }
  ...
  get(
    ...
    createRemboursementDto: CreateRemboursementDto,
  ) {
  ...
  update(
    ...
    return this.remboursementService.update(
      remboursementId,
      updateRemboursementDto,
    )
  }
