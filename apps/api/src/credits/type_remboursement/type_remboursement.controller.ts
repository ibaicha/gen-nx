...
export class TypeRemboursementController {
  constructor(
    private readonly typeRemboursementService: TypeRemboursementService,
  ) {}
  ...
  get(
    ...
    createTypeRemboursementDto: CreateTypeRemboursementDto,
  ) {
  ...
  update(
    ...
    return this.typeRemboursementService.update(
      typeRemboursementId,
      updateTypeRemboursementDto,
    )
  }
