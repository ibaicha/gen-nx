...
export class TypeUniteGrandeurController {
  constructor(
    private readonly typeUniteGrandeurService: TypeUniteGrandeurService,
  ) {}
  ...
  get(
    ...
    createTypeUniteGrandeurDto: CreateTypeUniteGrandeurDto,
  ) {
  ...
  update(
    ...
    return this.typeUniteGrandeurService.update(
      typeUniteGrandeurId,
      updateTypeUniteGrandeurDto,
    )
  }
